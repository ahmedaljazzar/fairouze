...
!function (e, t) {
  ...
  function c(e, t, n, r) {
    if (it.acceptData(e)) {
      var i, o, a = it.expando, s = e.nodeType, u = s ? it.cache : e,
        l = s ? e[a] : e[a] && a;
  ...
  function d(e, t, n) {
    if (it.acceptData(e)) {
      var r, i, o = e.nodeType, a = o ? it.cache : e,
  ...
  function F(e, t, n) {
    var r, i, o, a, s, u, l, c, d = this, f = {}, p = e.style,
      h = e.nodeType && At(e), m = it._data(e, "fxshow");
  ...
  var J = [], Y = J.slice, G = J.concat, Q = J.push, K = J.indexOf,
    Z = {}, et = Z.toString, tt = Z.hasOwnProperty, nt = {},
    rt = "1.11.3", it = function (e, t) {
      return new it.fn.init(e, t)
    }, ot = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, at = /^-ms-/,
    st = /-([\da-z])/gi, ut = function (e, t) {
  ...
  var lt = function (e) {
    ...
    var x, w, T, C, N, E, k, S, A, D, j, L, H, q, _, M, F, O, P,
      B = "sizzle" + 1 * new Date, R = e.document, W = 0, $ = 0,
      z = n(), I = n(), X = n(), U = function (e, t) {
        return e === t && (j = !0), 0
      }, V = 1 << 31, J = {}.hasOwnProperty, Y = [], G = Y.pop,
      Q = Y.push, K = Y.push, Z = Y.slice, et = function (e, t) {
      ...
      ft = new RegExp(at), pt = new RegExp("^" + it + "$"), ht = {
        ID: new RegExp("^#(" + rt + ")"),
        CLASS: new RegExp("^\\.(" + rt + ")"),
      ...
      }, mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i,
      vt = /^[^{]+\{\s*\[native \w/,
      yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/,
      xt = /'|\\/g,
    ...
    w = t.support = {}, N = t.isXML = function (e) {
      ...
      return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), _ = !N(r), w.attributes = i(function (e) {
        ...
        if (e === t) return j = !0, 0;
        var n, i = 0, o = e.parentNode, s = t.parentNode, u = [e],
          l = [t];
  ...
  var pt, ht = e.document, mt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
  ...
  it.Callbacks = function (e) {
    ...
    Deferred: function (e) {
      ...
      var t, n, r, i = 0, o = Y.call(arguments), a = o.length,
        ...
        u = 1 === s ? e : it.Deferred(), l = function (e, n, r) {
          return function (i) {
  ...
  it.extend({
    ...
    queue: function (e, t, n) {
      ...
      t = t || "fx";
      var n = it.queue(e, t), r = n.length, i = n.shift(),
        o = it._queueHooks(e, t), a = function () {
          it.dequeue(e, t)
        };
    ...
    queue: function (e, t) {
      ...
      var n, r = 1, i = it.Deferred(), o = this, a = this.length,
        s = function () {
          --r || i.resolveWith(o, [o])
        };
  ...
  var kt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    St = ["Top", "Right", "Bottom", "Left"], At = function (e, t) {
  ...
  !function () {
    var e = ht.createElement("input"), t = ht.createElement("div"),
  ...
  var Lt = /^(?:input|select|textarea)$/i, Ht = /^key/,
  ...
  it.event = {
    ...
    dispatch: function (e) {
      e = it.event.fix(e);
      var t, n, r, i, o, a = [], s = Y.call(arguments),
  ...
  var Ft = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
    ...
    Pt = new RegExp("<(?:" + Ft + ")[\\s/>]", "i"), Bt = /^\s+/,
    Rt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
    Wt = /<([\w:]+)/, $t = /<tbody/i, zt = /<|&#?\w+;/,
    It = /<(?:script|style|link)/i,
    Xt = /checked\s*(?:[^=]|=\s*.checked.)/i,
    Ut = /^$|\/(?:java|ecma)script/i, Vt = /^true\/(.*)/,
    Jt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Yt = {
  ...
  Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
    ...
    text: function (e) {
      ...
      e = G.apply([], e);
      var n, r, i, o, a, s, u = 0, l = this.length, c = this, d = l - 1,
        f = e[0], p = it.isFunction(f);
  ...
  it.Animation = it.extend(P, {
    ...
    fadeTo: function (e, t, n, r) {
      ...
      var i = it.isEmptyObject(e), o = it.speed(t, n, r),
        a = function () {
      ...
      return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
        var t = !0, i = null != e && e + "queueHooks", o = it.timers,
          a = it._data(this);
      ...
      return e !== !1 && (e = e || "fx"), this.each(function () {
        var t, n = it._data(this), r = n[e + "queue"],
          i = n[e + "queueHooks"], o = it.timers, a = r ? r.length : 0;
  ...
  var Tn, Cn, Nn = it.expr.attrHandle, En = /^(?:checked|selected)$/i,
    kn = nt.getSetAttribute, Sn = nt.input;
  it.fn.extend({
    attr: function (e, t) {
  ...
  _n = $n.exec(Mn.toLowerCase()) || [], it.extend({
    ...
    ajax: function (e, t) {
      ...
      var r, i, o, a, s, u, l, c, d = it.ajaxSetup({}, t),
        ...
        h = it.Deferred(), m = it.Callbacks("once memory"),
  ...
  it.offset = {
    setOffset: function (e, t, n) {
      var r, i, o, a, s, u, l, c = it.css(e, "position"), d = it(e),
        f = {};
...
!function (e, t, n) {
  ...
  var g, h, v = e.fn.init, m = e.parseJSON,
    y = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
  ...
  var x = e.event.add, Q = e.event.remove, k = e.event.trigger,
    N = e.fn.toggle, T = e.fn.live, S = e.fn.die,
 ...
 */
(function ($, h, c) {
  var a = $([]), e = $.resize = $.extend($.resize, {}), i,
    k = "setTimeout", j = "resize", d = j + "-special-event",
...
(function (a) {
  ...
  var y = "1.6.12", p = "left", o = "right", e = "up", x = "down",
    c = "in", A = "out", m = "none", s = "auto", l = "swipe",
    t = "pinch", B = "tap", j = "doubletap", b = "longtap", z = "hold",
    E = "horizontal", u = "vertical", i = "all", r = 10, g = "start",
    k = "move", h = "end", q = "cancel", a = "ontouchstart" in window,
  ...
  function D(a4, au) {
    ...
    var ag = 0, aP = null, ac = 0, a1 = 0, aZ = 0, H = 1, ap = 0,
      aJ = 0, N = null;
    var aR = f(a4);
    var aa = "start";
    var X = 0;
...
!function (e) {
  ...
  e.fn.attr2 = function () {
    ...
    function r(r) {
      var a, n, i = e.param(r, t.traditional).split("&"), o = i.length,
        s = [];
  ...
  t.fn.extend({
    easyResponsiveTabs: function (a) {
      var e = {
        ...
        }, a = t.extend(e, a), s = a, i = s.type, n = s.fit, r = s.width,
        c = "vertical", o = "accordion", d = window.location.hash,
      ...
      t(this).bind("tabactivate", function (t, e) {
        ...
        var s = t(this), p = s.find("ul.resp-tabs-list"),
          b = s.attr("id");
...
!function (a) {
  ...
  var o = {
      ...
      styles: []
    }, t = {map: {x: -73.9924068, y: 40.646197, zoom: 14}, locations: []},
    e = function (o, t) {
...
!function (e) {
  ...
  t.Defaults = {
    ...
    var o, s = [], n = [], a = e(this), r = a.find(i.options.applyTo),
      l = r.data("constraints").match(/\@\w+/g), c = r.val();
  ...
  t.Defaults = {
    ...
    this._core.$element.find(t._core.options.select.applyTo).on("focus", this.focus).on("blur", function () {
      ...
      var i = e(this), o = i.parent().find("select"),
  ...
  t.Defaults = {
    ...
    for (var r = o.data("date"), l = o.data("pickedDate"), c = new Date(r.getFullYear(), r.getMonth() + 1, 0).getDate(), p = new Date(r.getFullYear(), r.getMonth(), 0).getDate(), d = new Date(r.getFullYear(), r.getMonth(), 1).getDay(), f = 1, a = 0; 7 > a; a++) {
      n = e("<tr/>");
      for (var h = 0; 7 > h; h++) {
        var u, m = 7 * a + h + 1, g = e("<td/>", {"class": "dp-day"}),
          y = new Date;
  ...
  t.Defaults = {
    ...
    t._core.$element.on("mf.process", function () {
      e(this).find("." + t._core.options.progress["class"]).removeClass("hide").addClass("sending").find(".msg")
  ...
  (function (c, n, m) {
    ...
    l = function () {
      ...
      d.prototype.stickUp = function (a, b) {
        ...
        if (h) {
          if (e >= d && !a.isStuck || e < d && a.isStuck) if (a.$element.add(a.$clone).find("[data-rd-navbar-toggle]").each(function () {
              c.proxy(a.closeToggle,
                this)(a, !1)
            }).end().find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"), e >= d && !a.isStuck) "resize" === b.type ? a.switchClass(g, "", "rd-navbar--is-stuck") : g.addClass("rd-navbar--is-stuck"), a.isStuck = !0, a.options.callbacks.onStuck && a.options.callbacks.onStuck.call(a); else {
            if ("resize" === b.type) a.switchClass(g, "rd-navbar--is-stuck", ""); else g.removeClass("rd-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", c.proxy(a.resizeWrap, a, b));
            a.isStuck = !1;
      ...
      d.prototype.createNav = function (a) {
        ...
        }).parents("li").addClass("rd-navbar-submenu").append(c("<span/>", {"class": "rd-navbar-submenu-toggle"}));
      ...
      d.prototype.goToAnchor = function (a, b) {
        ...
        d = this.hash;
        e = c(d);
        e.length && (b.preventDefault(), c("html, body").stop().animate({scrollTop: e.offset().top + a.getOption("anchorNavOffset") + 1}, a.getOption("anchorNavSpeed"), a.getOption("anchorNavEasing"), function () {
...
(function () {
  (function (d, t, n) {
    ...
    q = -1 !== navigator.appVersion.indexOf("MSIE") || 0 < navigator.appVersion.indexOf("Trident/");
    p = function () {
      function c(a, f) {
      ...
      c.prototype.initialize = function () {
        ...
        a.$element.parents().each(function () {
          ...
          for (b in e) e.hasOwnProperty(b) && null != this.style[b] && (f = n.getComputedStyle(this).getPropertyValue(e[b]));
          if (null != f && 0 < f.length && "none" !==
            f) return a.$anchor = d(this), !1
        }).end().wrapInner(d("<div/>", {"class": "rd-parallax-inner"})).find(".rd-parallax-layer[data-type]").each(function () {
          var f, b;
          f = d(this);
          switch (f.attr("data-type").toLowerCase()) {
            case "media":
              if (b = this.getAttribute("data-url")) f.css({"background-image": a.url(b)}), ("true" === this.getAttribute("data-blur") || a.options.blur) && d("<img/>", {src: b}).load(function () {
              ...
              if (l) a.$win.on("orientationchange", d.proxy(a.resizeMedia, this, a)); else a.$win.on("resize", d.proxy(a.resizeMedia, this, a))
          }
          if (l) a.$win.on("resize orientationchange", d.proxy(a.moveLayer, this, a)); else a.$doc.on("scroll", d.proxy(a.moveLayer, this, a)), a.$win.on("resize", d.proxy(a.moveLayer, this, a)), "true" === this.getAttribute("data-fade") && (a.$doc.on("scroll",
      ...
      c.prototype.moveLayer = function (a) {
        ...
        null != (f = this.getAttribute("data-agent")) ?
          e = (f = d(f)).length ? (g + k - (f.offset().top + k)) / (k - b) : .5 : "media" !== this.getAttribute("data-type") ? g < k || g > e - k ? (e = g < k ? g / (k - b) : (g + k - e) / (k - b), isFinite(e) || (e = 0)) : e = .5 : e = .5;
        if (l) return f = (b - r) / 2, d(this).css(a.transform(f, a));
        f = -(g - c) * m + (b - r) / 2 + (k - b) * e * m + parseInt(a.getAttribute(this, "offset"));
        if (c + k >= g && c <= g + b || "true" === this.getAttribute("data-unbound")) return d(this).css(a.transform(f, a))
      };
      c.prototype.moveCanvas = function (a, f) {
        ...
        e = a.$anchor ? a.$element.position().top :
          e - c;
        return b.css({top: e})
      };
      c.prototype.fadeLayer = function (a, f) {
        ...
        h = b / 6;
        if (e + h > g && e - h < g) return c.css({opacity: 1});
        b = e - h < g ? 1 + (e + h - g) / b / 3 * 10 : 1 - (e - h - g) / b / 3 * 10;
        return c.css({opacity: 0 > b ? 0 : 1 < b ? 1 : b.toFixed(2)})
      };
      ...
      c.prototype.resizeCanvas = function (a) {
        return d(this).css({
          position: q && a.$anchor ? "relative" : "fixed",
          left: q ? "auto" : a.$anchor ? a.$element.offset().left - a.$anchor.offset().left :
            a.$element.offset().left,
          width: a.$element.width()
        })
      };
      c.prototype.fitCanvas = function (a) {
        return setTimeout(function () {
          return a.$canvas.css({height: a.$element.parent().parent().height()})
        })
      };
      c.prototype.getMediaHeight = function (a, f, b, e) {
        b = Math.max(parseFloat(b), 0);
        b = Math.min(parseFloat(b), 2);
        return f + (-1 === e ? (f + a) * b : 0) + (1 >= b ? Math.abs(a - f) * b : a * b) + 56
      };
      ...
      c.prototype.transform = function (a, f) {
        return {
          "-webkit-transform": "matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,0," +
          a + ",0,1)",
      ...
      c.prototype.getAttribute = function (a, f) {
        var b, e, c, d, h;
        if (null != this.options.screenAliases) for (e = Object.keys(this.options.screenAliases).reverse(), c = d = 0, h = e.length - 1; (0 <= h ? d <= h : d >= h) && !(b = "" !== this.options.screenAliases[e[c]] ? "-" + this.options.screenAliases[e[c]] : this.options.screenAliases[e[c]],
          b = a.getAttribute("data" + b + "-" + f), e[c] <= this.$win.width() && null != b); c = 0 <= h ? ++d : --d) ;
        return null != b ? b : this.options[f]
      };
      return c
    }();
    d.fn.extend({
      RDParallax: function (c) {
        return this.each(function () {
          var a;
          a = d(this);
          if (!a.data("RDParallax")) return a.data("RDParallax", new p(this, c))
        })
      }
    });
    return n.RDParallax = p
  })(window.jQuery, document, window);
...
if ($("html").hasClass("smoothscroll")) {
  function ssc_init() {
    if (document.body) {
      var a = document.body, b = document.documentElement,
        c = window.innerHeight, d = a.scrollHeight;
    ...
    if (d || (d = 1E3), ssc_directionCheck(b, c), ssc_que.push({
      ...
      var e = function () {
        for (var n = +new Date, h = 0, m = 0, k = 0; k < ssc_que.length; k++) {
          var f = ssc_que[k], l = n - f.start, p = l >= ssc_animtime,
  ...
  if (-1 === navigator.platform.toUpperCase().indexOf("MAC") && !navigator.userAgent.match(/(Android|iPod|iPhone|iPad|IEMobile|Opera Mini|BlackBerry)/)) {
    var ssc_framerate = 150, ssc_animtime = 700, ssc_stepsize = 100,
      ssc_pulseAlgorithm = !0, ssc_pulseScale = 8,
      ssc_pulseNormalize = 1, ssc_keyboardsupport = !0,
      ssc_arrowscroll = 50, ssc_frame = !1,
      ssc_direction = {x: 0, y: 0}, ssc_initdone = !1,
      ssc_fixedback = !0, ssc_root = document.documentElement,
  ...
  m = {
    ...
    if (this.settings.loop) {
      var e = c - this.relative(this.current()), f = this.current(),
        g = this.current(), h = this.current() + e,
        i = 0 > g - h ? !0 : !1,
    ...
    if (v.params = s, v.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (v.$ = a, v.container = a(e), 0 !== v.container.length)) {
      ...
      v.container[0].swiper = v, v.container.data("swiper", v), v.classNames.push("swiper-container-" + v.params.direction), v.params.freeMode && v.classNames.push("swiper-container-free-mode"), v.support.flexbox || (v.classNames.push("swiper-container-no-flexbox"), v.params.slidesPerColumn = 1), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push("swiper-container-3d")) : v.params.effect = "slide"), "slide" !== v.params.effect && v.classNames.push("swiper-container-" + v.params.effect), "cube" === v.params.effect && (v.params.resistanceRatio = 0, v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.centeredSlides = !1, v.params.spaceBetween = 0, v.params.virtualTranslate = !0, v.params.setWrapperSize = !1), "fade" === v.params.effect && (v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.watchSlidesProgress = !0, v.params.spaceBetween = 0, "undefined" == typeof f && (v.params.virtualTranslate = !0)), v.params.grabCursor && v.support.touch && (v.params.grabCursor = !1), v.wrapper = v.container.children("." + v.params.wrapperClass), v.params.pagination && (v.paginationContainer = a(v.params.pagination), v.params.paginationClickable && v.paginationContainer.addClass("swiper-pagination-clickable")), v.rtl = r() && ("rtl" === v.container[0].dir.toLowerCase() || "rtl" === v.container.css("direction")), v.rtl && v.classNames.push("swiper-container-rtl"), v.rtl && (v.wrongRTL = "-webkit-box" === v.wrapper.css("display")), v.params.slidesPerColumn > 1 && v.classNames.push("swiper-container-multirow"), v.device.android && v.classNames.push("swiper-container-android"), v.container.addClass(v.classNames.join(" ")), v.translate = 0, v.progress = 0, v.velocity = 0, v.lockSwipeToNext = function () {
        ...
        var e, a = v.params.spaceBetween,
          t = -v.params.slidesOffsetBefore, s = 0, n = 0;
      ...
      var b, y, x, T, S, C, M, P, z,
        I = "input, select, textarea, button", E = Date.now(), k = [];
          ...
          if (e.originalEvent && (e = e.originalEvent), v.emit("onTouchEnd", v, e), b) {
            ...
            if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -S, v.params.freeMode) {
              ...
              if (v.params.freeModeMomentum) {
                if (k.length > 1) {
                  var i = k.pop(), n = k.pop(),
                    o = i.position - n.position, l = i.time - n.time;
                ...
                var p = 1e3 * v.params.freeModeMomentumRatio,
                  d = v.velocity * p, c = v.translate + d;
                v.rtl && (c = -c);
                var u, m = !1,
          ...
          fade: {
            setTranslate: function () {
              for (var e = 0; e < v.slides.length; e++) {
                var a = v.slides.eq(e), t = a[0].swiperSlideOffset,
                  s = -t;
            ...
            setTranslate: function () {
              ...
              for (var s = 0; s < v.slides.length; s++) {
                var i = v.slides.eq(s), n = 90 * s,
                  o = Math.floor(n / 360);
                v.rtl && (n = -n, o = Math.floor(-n / 360));
                var l = Math.max(Math.min(i[0].progress, 1), -1), p = 0,
                  d = 0, c = 0;
            ...
            setTranslate: function () {
              for (var e = v.translate, t = r() ? -e + v.width / 2 : -e + v.height / 2, s = r() ? v.params.coverflow.rotate : -v.params.coverflow.rotate, i = v.params.coverflow.depth, n = 0, o = v.slides.length; o > n; n++) {
                var l = v.slides.eq(n), p = v.slidesSizesGrid[n],
            ...
            if ("undefined" != typeof e && ("undefined" == typeof t && (t = !0), 0 !== v.slides.length)) {
              ...
              !s.hasClass("swiper-lazy") || s.hasClass("swiper-lazy-loaded") || s.hasClass("swiper-lazy-loading") || (r = r.add(s[0])), 0 !== r.length && r.each(function () {
                ...
                var r = e.attr("data-background"),
                  i = e.attr("data-src"), n = e.attr("data-srcset");
